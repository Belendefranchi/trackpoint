        ...
        <tr>
          ...
          <td class="border text-center">
            <?php if ($tipo['habilitado']): ?>
              <form method="POST" class="formLogDeshabilitar" action="/trackpoint/public/index.php?route=/sistema/ABMs/logs&deshabilitar">
            ...
            <?php else: ?>
              <form method="POST" class="formLogHabilitar" action="/trackpoint/public/index.php?route=/sistema/ABMs/logs&habilitar">
                <input type="hidden" name="tipo" value="<?= htmlspecialchars($tipo['tipo']) ?>">
...
<!-- Script -->
<script src="/trackpoint/public/assets/js/menu_sistema/menu.sistemas.js"></script>
