...
(
	...
	-- Estado inicial de la recepción
);
GO
...
(
	...
	-- ID único de cada fila temporal
	recepcion_id INT NOT NULL,
	-- ID único por grupo de mercaderías (puede ser el GUID de toda la recepción)
